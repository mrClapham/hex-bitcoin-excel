...
This should start a simple Node server at [http://localhost:9070](http://localhost:8088), then, click the link below to install as an openFin app.
...
[installer](https://dl.openfin.co/services/download?fileName=openfin_appseed&config=http://localhost:8088/app.json)